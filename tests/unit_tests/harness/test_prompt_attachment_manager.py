...
@pytest.mark.parametrize(
    ...
    [
        (ProviderType.DeepSeek, None, "chat-completions", False),
        (ProviderType.DeepSeek, None, "anthropic-messages", False),
        (ProviderType.DashScope, None, "chat-completions", True),
        (ProviderType.DashScope, None, "anthropic-messages", False),
        (ProviderType.OpenAI, "dashscope", "chat-completions", True),
        (ProviderType.OpenAI, "dashscope", "anthropic-messages", False),
        (ProviderType.OpenAI, "bailian", "chat-completions", True),
        (ProviderType.OpenAI, "openai", "chat-completions", False),
