...
_CN_TOOL_CALLS_HEADING = "\u5de5\u5177\u8c03\u7528\u547d\u4ee4\u5982\u4e0b\uff1a"
_CN_TOOL_RESULTS_HEADING = "\u5de5\u5177\u6267\u884c\u7ed3\u679c\u5982\u4e0b\uff1a"
_CN_SEED = "\u8bf7\u751f\u6210\u7814\u7a76\u60f3\u6cd5"
...
@pytest.mark.asyncio
async def test_compacts_identical_tool_args_and_results():
...
@pytest.mark.asyncio
async def test_different_results_do_not_compact():
