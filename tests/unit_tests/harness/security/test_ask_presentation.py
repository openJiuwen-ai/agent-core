...
from openjiuwen.harness.security.approve.ask_presentation import build_permission_ask_presentation
from openjiuwen.harness.security.toolguard.findings import GuardFinding
...
def test_path_ask_uses_path_title_and_write_summary() -> None:
    ...
    msg = __import__(
        "openjiuwen.harness.security.approve.ask_presentation",
...
def test_render_message_puts_summary_first() -> None:
    from openjiuwen.harness.security.approve.ask_presentation import render_ask_presentation_message
