                            ...
                            "spans": [
                                {
                                    ...
                                    "attributes": attributes_from_map(
                                        {"langfuse.gen_ai.prompt.0.role": "user", "langfuse.gen_ai.prompt.0.content": "x"}
                                    ),
                                }
                            ]
                        }
...
def test_run_sleep_cycle_applies_llm_rubric_synthesis(tmp_path: Path) -> None:
    ...
    tasks = [
        TaskRecord(
            id="r1", project="unit", intent="wrap", reference_kind="rubric", reference="- base",
            split="train", skill_hint="skill-a",
        ),
        TaskRecord(
            id="e1", project="unit", intent="exact", reference_kind="exact", reference="42",
            split="val", skill_hint="skill-a",
        ),
    ]
