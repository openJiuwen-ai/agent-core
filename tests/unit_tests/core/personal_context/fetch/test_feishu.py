...
from openjiuwen.core.personal_context.fetch.feishu import FeishuFetchService, _fetch_wiki_content
...
def _fake_cli(monkeypatch: pytest.MonkeyPatch, responses: dict[tuple[str, ...], list[object]]) -> list[list[str]]:
    import openjiuwen.core.personal_context.fetch.feishu as feishu_module
