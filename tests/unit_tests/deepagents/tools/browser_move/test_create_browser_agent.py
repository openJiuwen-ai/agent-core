...
def _patch_all(fake_create, *, runtime_mock=None, fake_tools=None):
    ...
    mock_runtime_cls = stack.enter_context(
        patch("openjiuwen.deepagents.subagents.browser_agent.BrowserAgentRuntime")
    )
    ...
    mock_build_tools = stack.enter_context(
        patch("openjiuwen.deepagents.subagents.browser_agent.build_browser_runtime_tools", return_value=tools)
    )
    stack.enter_context(
        patch(
            "openjiuwen.deepagents.subagents.browser_agent.create_deep_agent",
