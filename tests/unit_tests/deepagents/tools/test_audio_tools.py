...
from openjiuwen.deepagents.schema.config import AudioModelConfig
...
def test_audio_transcription_tool_transcribes_local_audio(
    ...
    monkeypatch.setattr(
        "openjiuwen.deepagents.tools.audio._invoke_audio_transcription",
...
def test_audio_question_answering_tool_returns_answer_and_duration(
    ...
    monkeypatch.setattr(
        "openjiuwen.deepagents.tools.audio._invoke_audio_question_answering",
