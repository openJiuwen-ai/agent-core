"""Pydantic contracts shared by the embedded proactive context core."""
...
_PCSState = Literal["CREATED", "CONFIGURED", "STARTING", "RUNNING", "STOPPING", "STOPPED", "FAILED"]
...
class PCSStatus(BaseModel):
    """Bounded, credential-free snapshot of PCS runtime state."""
