"""Configuration contracts for the embedded proactive context core."""
...
class PCSFetchServiceConfig(BaseModel):
...
class PCSConfig(BaseModel):
    """Complete immutable PCS configuration parsed from a plain dictionary."""
    ...
    fetch_services: tuple[PCSFetchServiceConfig, ...]

    @classmethod
    def from_dict(cls, config: dict[str, object]) -> "PCSConfig":
    ...
    def validate_semantics(self) -> "PCSConfig":
