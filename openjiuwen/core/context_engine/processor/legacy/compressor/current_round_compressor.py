...
from openjiuwen.core.context_engine.processor.legacy.compressor.util import (
...
class LegacyCurrentRoundCompressorConfig(BaseModel):
    """
    Configuration for LegacyCurrentRoundCompressor.
...
class LegacyCurrentRoundCompressor(ContextProcessor):
    """
    ...
    **This implementation was updated** to keep compressed output in a
    ...
    """
    def __init__(self, config: LegacyCurrentRoundCompressorConfig):
    ...
    def _wrap_memory_block(self, summary: str) -> str:
        ...
        **This is one of the key changes in this iteration**: the compressed
        ...
        return (
            f"{_SUMMARY_MARKER}\n"
            "processor: LegacyCurrentRoundCompressor\n"
