...
class LegacyDialogueCompressorConfig(BaseModel):
...
class LegacyDialogueCompressor(ContextProcessor):
    def __init__(self, config: LegacyDialogueCompressorConfig):
    ...
    def _wrap_memory_block(summary: str) -> str:
        return (
            ...
            "processor: LegacyDialogueCompressor\n"
