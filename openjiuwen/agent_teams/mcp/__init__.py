...
agent (claudecode / codex / ...) connects over stdio; the descriptor is read
from the ``OPENJIUWEN_TEAM_JOIN`` environment variable. This is the
repository's first MCP *server* (the rest of the codebase is an MCP client).
"""
