...
This team includes human members who represent real human operators and stand on equal footing with you and the other teammates; the current roster is provided separately. The following rules apply to every member whose role is `human_agent`:
