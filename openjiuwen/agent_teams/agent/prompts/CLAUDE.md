...
| `leader_workflow_predefined.md` | Leader 且 `team_mode="predefined"` | `workflow_section` | 预定义团队工作流：禁止 `spawn_member`，成员已预先注册 |
| `leader_workflow_hybrid.md` | Leader 且 `team_mode="hybrid"` | `workflow_section` | 混合团队工作流：预注册基础成员 + 允许动态 `spawn_member` 扩员 |
