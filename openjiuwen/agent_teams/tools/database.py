...
"""agent_card Team Database Module

This module provides database abstraction for storing team data using SQLAlchemy.
Supports SQLite and can be extended to other SQL databases.
"""
