...
│   ├── journal.py       # content-addressed resume（结构化 call-path 键 + sig）+ run 级记录（launch / pause / seal；get_cached 按 run_id 双重检查 / find_run_record / write_run_record，F_87 / F_88）
