...
def evolution_edge_key(source_id: str, target_id: str, relation_type: str = CAN_FEED) -> str:
...
def normalize_known_skill_ids(
    ...
    *,
    ...
    for value in values:
        ...
        if current_skill_id and current_skill_id not in seen and current_skill_id in known_skill_ids:
