...
from openjiuwen.symphony.orchestration.graph.matcher.prompt import (
    SYSTEM_PROMPT,
    build_llm_context,
...
from openjiuwen.symphony.interfaces import llm_usage_context, thinking_disabled_request_overrides
...
class OpenAICompatibleOntologyMatcher:
    ...
    def __init__(
        ...
        *,
        ...
        self.config = getattr(llm_client, "config", None)
    ...
    async def _request_and_validate_batch(
        ...
        *,
        ...
        _apply_explicit_rejections(raw_payload)
...
def _apply_explicit_rejections(payload: Dict[str, Any]) -> None:
    """A false-like explicit accepted flag must never become truthy by coercion."""
