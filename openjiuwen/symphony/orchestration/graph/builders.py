"""Build typed Skill graph and graph lookup artifacts."""
...
class GraphLookupBuilder:
    """Build deterministic lookup tables for online graph retrieval."""
    ...
    def build(self, registry: SkillRegistry, graph: SkillGraph) -> GraphLookup:
