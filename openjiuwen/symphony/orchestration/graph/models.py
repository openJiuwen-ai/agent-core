...
class SkillRegistry:
    ...
    def ordered_skills(self) -> List[FingerprintLike]:
...
@dataclass(frozen=True)
class GraphLookup:
    """Lookup tables used by online graph retrieval and planning."""
...
class BuildManifest:
    ...
    schema_version: str = "Orchestration-graph-v1"
    artifacts: Dict[str, str] = field(
        default_factory=lambda: {
            "skills": "skills.json",
            "graph": "skill_graph.json",
            "graph_lookup": "graph_lookup.json",
