...
def edge_identity_from_observation(
    ...
    matches = [
        ...
        and candidate.relation_type == edge.relation_type
        and candidate.source_content_hash == source.content_hash
        and candidate.target_content_hash == target.content_hash
        and candidate.port_mapping_hash == mapping_hash
    ]
