...
class DataTypeVocabulary:
    ...
    TYPE_HIERARCHY = {
        "markdown": frozenset({"file", "text"}),
        "json": frozenset({"file", "object", "text"}),
        "csv": frozenset({"file", "table", "text"}),
        "table": frozenset({"object", "text"}),
        "yaml": frozenset({"file", "object", "text"}),
        "xml": frozenset({"file", "object", "text"}),
        ...
        "mp3": frozenset({"audio", "file"}),
        "wav": frozenset({"audio", "file"}),
        "video": frozenset({"file"}),
        "mp4": frozenset({"video", "file"}),
        "path": frozenset({"file"}),
