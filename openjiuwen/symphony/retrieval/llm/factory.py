...
from ..search.runtime.types import ProgressiveRetrieverConfig
...
def create_progressive_client(
    *,
    ...
    if _needs_local_vllm_generation_client(llm_client_config) and not isinstance(
        resolved_generation_client, LocalVLLMClient
    ):
        ...
        vllm_kwargs.setdefault(
            ...
            max(1, int(str(vllm_kwargs.get("tensor_parallel_size", 1) or 1))),
        )
        LOGGER.info(
