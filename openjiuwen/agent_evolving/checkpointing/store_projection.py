...
class StoreProjectionHelper:
    ...
    async def render_evolution_markdown(self, name: str, *, subject_kind: Optional[str] = None) -> None:
        ...
        # Never inject an Experience Index into SKILL.md; strip any legacy block.
        await self.strip_skill_md_evolution_index(skill_dir)
    ...
    async def strip_skill_md_evolution_index(self, skill_dir: Path) -> None:
        """Remove a leftover ``<!-- evolution-index-* -->`` block from SKILL.md if present."""
