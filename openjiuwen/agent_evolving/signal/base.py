...
class EvolutionSignal:
    ...
    Attributes:
        ...
        evolution_type: Deprecated compatibility field.
        tool_name: Deprecated compatibility field; prefer ``context['tool_name']``.
    """
    ...
    evolution_type: EvolutionCategory = EvolutionCategory.SKILL_EXPERIENCE
