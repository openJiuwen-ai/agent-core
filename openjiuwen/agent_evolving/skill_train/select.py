...
def rank_and_select(
    ...
    patch : dict
        Merged :class:`~openjiuwen.agent_evolving.skill_train.types.Patch` dict with ``edits`` list.
    max_edits : int
    ...
    -------
    dict
        :class:`~openjiuwen.agent_evolving.skill_train.types.Patch` dict with selected edits and
