...
from openjiuwen.agent_evolving.skill_train.model_compat import get_reasoning_effort, get_target_client, _needs_responses_api, tracker
from openjiuwen.agent_evolving.skill_train.envs._codex_stub import is_target_exec_backend
from openjiuwen.agent_evolving.skill_train.model_compat import get_codex_exec_config, get_target_backend
from openjiuwen.agent_evolving.skill_train.envs._codex_stub import prepare_workspace, render_skill_md, run_target_exec
from openjiuwen.agent_evolving.skill_train.prompts_loader import load_prompt
from openjiuwen.agent_evolving.skill_train.envs.spreadsheetbench.executor import run_generated_code
from openjiuwen.agent_evolving.skill_train.envs.spreadsheetbench.evaluator import evaluate
...
def _get_deployment() -> str:
    from openjiuwen.agent_evolving.skill_train.llm_client import get_target_client
    return get_target_client().model
            ...
            if not code.strip():
                ...
                if ok:
                    if gold_path and answer_position:
                        from openjiuwen.agent_evolving.skill_train.envs.spreadsheetbench.rollout import _auto_verify_output
