...
from openjiuwen.agent_evolving.skill_train.envs.livemathematicianbench.evaluator import evaluate
    ...
    *,
    ...
    try:
        ...
        if is_target_exec_backend():
            from openjiuwen.agent_evolving.skill_train import model_compat as _llm
    ...
    *,
    ...
    def _timeout_result(it: dict) -> dict:
        ...
        return {
            ...
            "task_description": it.get("question", ""),
