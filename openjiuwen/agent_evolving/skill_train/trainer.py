...
def _display_epoch(epoch_idx: int) -> int:
    """Map 0-based trainer epoch index to skill_train 1-based display epoch."""
    ...
    def train(
        ...
        *,
        ...
        for epoch in range(num_epochs):
            ...
            if use_meta:
                # skill_train loads meta from previous 1-based epoch (= our epoch index).
            ...
            # ── SLOW UPDATE (end of epoch; order: slow then meta) ──
            if use_slow:
