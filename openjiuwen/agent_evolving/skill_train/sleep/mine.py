...
_GREETINGS = frozenset(
    {
        "你好", "您好", "hi", "hello", "hey", "嗨", "哈喽", "在吗", "在么",
        "谢谢", "感谢", "多谢", "thanks", "thank you", "thx", "ok", "okay",
        "好的", "好", "嗯", "嗯嗯", "行", "收到", "明白", "了解", "知道了",
        "早上好", "下午好", "晚上好", "good morning", "good afternoon", "bye", "再见",
    }
)
_STRONG_CORRECTION = (
    "不对", "错了", "错误", "不正确", "缺少", "少了", "漏了", "遗漏", "不是这个",
    "不是我要的", "不完整", "重来", "wrong", "incorrect", "missing", "not what i",
)
_WEAK_CORRECTION = (
    "需要", "应该", "还要", "还需要", "补充", "重新", "没有", "加上", "改成", "换成",
    "再加", "也要", "should", "need", "add", "again", "instead",
)
...
_MISSING_RE = re.compile(r"^(?:这个|这)?(?:不对|错了)?[，,。\s]*(?:缺少|少了|漏了|遗漏|没有|缺)(?:了)?[:：]?\s*(?P<what>.+)$")
_TRAILING_PUNCT = "。！!，,；;、 \t"
