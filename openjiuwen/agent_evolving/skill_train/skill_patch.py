...
if TYPE_CHECKING:
    from openjiuwen.agent_evolving.skill_train.types import Edit as EditType, Patch as PatchType
...
def apply_edit(skill: str, edit: EditType | dict) -> str:
    ...
    edit : Edit | dict
        An :class:`~openjiuwen.agent_evolving.skill_train.types.Edit` instance or a plain dict with
...
def apply_patch(skill: str, patch: PatchType | dict) -> str:
    ...
    skill : str
        Current skill document content.
    patch : Patch | dict
        A :class:`~openjiuwen.agent_evolving.skill_train.types.Patch` instance or a plain dict with
