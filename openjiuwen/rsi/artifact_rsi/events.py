...
"""Provider-to-AgentServer event contracts for artifact optimization."""
...
from openjiuwen.rsi.artifact_rsi.schema import RsiStatus, RsiTreeNode, RsiUsage
...
async def emit(on_event: OnEvent | None, event: EngineEvent) -> None:
    ...
    Providers should call this only after the state, node, report, or artifact
