...
OJ_INPUT_MESSAGES_ORDERED = "openjiuwen.gen_ai.input_messages.ordered"
...
# Backward-compatible internal aliases retained from dev-stable. New Trace
# projection code does not rely on them, but downstream integrations may.
