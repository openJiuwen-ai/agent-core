...
def _runtime_sticky_subagent_type(subagent_type: str) -> bool:
    # Browser process/profile reuse is owned by BrowserServiceRegistry.
    # Persistent runtime spawn IDs follow develop: only verification_agent is sticky.
