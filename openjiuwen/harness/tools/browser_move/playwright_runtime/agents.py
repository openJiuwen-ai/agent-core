...
def build_browser_worker_system_prompt(
    ...
    return (
        ...
        "After a successful card probe, use a browser_run_code tool only when it is "
        "explicitly present, for a clearly missing required field or a specific target-based action; "
        "do not repeat broad extraction "
        ...
        "Use a browser_run_code tool only when it is present "
        "in the current tool list and compact probes, snapshot, and deterministic actions are "
