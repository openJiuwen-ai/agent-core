...
"""Manifest declarations for built-in DeepAgent rails / tools.
...
from openjiuwen.harness.tools.audio import AudioMetadataTool, create_audio_tools
from openjiuwen.harness.tools.vision import create_vision_tools
...
# ENT web_tools exposes the paid tool but not DEV's is_paid_search_enabled helper.
