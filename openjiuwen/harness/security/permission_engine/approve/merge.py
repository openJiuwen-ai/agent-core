...
"""HITL merge pure functions. Product YAML I/O still goes through Host when present."""
...
def merge_permission_allow_rule_into_permissions(
    ...
    from openjiuwen.harness.security.permission_engine.toolguard.tiered_policy import evaluate_tiered_policy
