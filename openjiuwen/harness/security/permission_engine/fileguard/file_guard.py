...
from openjiuwen.harness.security.permission_engine.toolguard.patterns import contains_path
from openjiuwen.harness.security.permission_engine.toolguard.tiered_policy import (
    _PATH_TOOLS,
    _iter_path_strings,
...
class ExternalDirectoryChecker:
    """Deprecated：检查 workspace 外路径；内部转调 :class:`FileGuardChecker`。

    新代码请直接使用 :func:`build_file_guard_checker` 或 :class:`FileGuardChecker`。
    """
