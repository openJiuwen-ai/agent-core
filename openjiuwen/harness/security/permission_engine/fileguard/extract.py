...
from openjiuwen.harness.security.permission_engine.fileguard.registry import (
    FileToolSpec,
...
from openjiuwen.harness.security.permission_engine.toolguard.tiered_policy import _PATH_TOOLS, _iter_path_strings
