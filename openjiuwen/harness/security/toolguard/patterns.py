...
"""Wildcard / path / URL / command matchers for Pipeline A.

Persist helpers live in :mod:`openjiuwen.harness.security.approve.persist` and
are re-exported here for jiuwenswarm and the ``security.patterns`` shim.
"""
