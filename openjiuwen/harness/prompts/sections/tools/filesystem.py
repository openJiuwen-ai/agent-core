...
READ_FILE_DESCRIPTION: Dict[str, str] = {
    ...
    "en": (
        ...
        "do not call read_file without pages again on the same large PDF."
    ),
}
...
READ_FILE_PARAMS: Dict[str, Dict[str, str]] = {
    ...
    "pages": {
        "cn": "PDF 专属页码范围，例如 '1-10'、'3'、'11-20'。每次最多 10 页",
        "en": "PDF-only page range, e.g. '1-10', '3', '11-20'. Maximum 10 pages per request",
    },
}
