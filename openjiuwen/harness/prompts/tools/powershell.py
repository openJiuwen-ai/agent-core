...
DESCRIPTION: Dict[str, str] = {
    "cn": (
        ...
        "本工具用于通过 PowerShell 执行终端操作，例如 git、npm、docker、"
        "python 和 PowerShell cmdlet。\n\n"
    ...
    "en": (
        ...
        "This tool is for terminal operations via PowerShell: git, "
        "npm, docker, python, and PowerShell cmdlets.\n\n"
        ...
        " - Communicate directly instead of using `Write-Output` or `Write-Host`\n"
