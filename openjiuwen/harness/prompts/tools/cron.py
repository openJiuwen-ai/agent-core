...
[targets] Leave empty unless user explicitly specifies a channel; system uses current channel.
**Never infer from history.**
...
(run at the scheduled time, no early wake).
Do not pass 60 for query/preparation tasks, or any other inferred positive value from task type,
time until trigger, or history.
