...
- 提供轨迹类型与抽取（Trajectory、TracerTrajectoryExtractor）、更新生产者（UpdateProducer、SingleDimProducer、MultiDimProducer）；
...
| [producer](openjiuwen.agent_evolving/producer.md) | 更新生产者（UpdateProducer、SingleDimProducer、MultiDimProducer） |
