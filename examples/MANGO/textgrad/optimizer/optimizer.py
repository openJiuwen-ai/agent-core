...
class TextualGradientDescent(Optimizer):
    ...
    async def step(self):
        ...
        for parameter in self.parameters:
            ...
            print("optimizer system prompt: "+self.optimizer_system_prompt)
            new_text = await self.engine(prompt_update_parameter, system_prompt=self.optimizer_system_prompt, temperature=0.7)
            # new_text = self.engine(prompt_update_parameter, system_prompt=self.optimizer_system_prompt, temperature=0.5)
