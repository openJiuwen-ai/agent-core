...
_OUTCOME_ONLY_CAUSAL_PATTERNS = (
    ...
    re.compile(
        r"\b(?:match|align|alignment)\b.{0,40}\b(?:expected|gold|scored)\s+(?:answer|label|verdict|outcome)\b",
        re.IGNORECASE,
    ),
...
def _global_submission_checkpoint_errors(instruction: str) -> list[str]:
    ...
    token_groups = {
        ...
        "computed or derived values": ("compute", "computed", "calculation", "calculate", "derived", "numeric"),
